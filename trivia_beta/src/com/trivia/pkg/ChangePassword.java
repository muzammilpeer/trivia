...
public class ChangePassword extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final TextView loadingtextview = (TextView)findViewById(R.id.loadingtext);
        //final ProgressDialog dialog = ProgressDialog.show(this,"", "Checking Database..");
        
    	Handler handler = new Handler(); 
	      handler.postDelayed(new Runnable() { 
	           public void run() {
	        	   if ( CheckDatabaseExist() == 0)
	        	   {
	        		   loadingtextview.setText("Database Initializing...");
	        	       LoadSampleQueries();
	        	   }
	        	   RestCounter();
	        	   nextAc();
    ...
    private void nextAc()
    {
        Intent next = new Intent(this,com.trivia.pkg.loading.class);
        this.startActivity(next);
        this.finish();
    }
    private int CheckDatabaseExist()
    {
    	int count=0;
    	try
    	{
    	 count = db.getMovieTotalCount();
    	 return count;
    	}
    	catch (Exception e)
    	{
//    		Toast.makeText(getApplicationContext(), e.toString(),1).show();
    ...
    private void LoadSampleQueries()
    {
    	try
    	{
    		...
    		db.addRow_Quote(1,1,"That tall drink of water with the silver spoon up his ass.",0,0);
    		db.addRow_Quote(2,1,"I believe in two things: discipline and the Bible. Here you' ll receive both. Put your trust in the Lord; your ass belongs to me.",0,0);
    		...
    		db.addRow_Quote(39,3,"I^d give four million just to be able to take a piss without it hurting",0,0);
